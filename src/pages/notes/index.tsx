		...
		<div className="container max-w-4xl min-h-screen flex items-center justify-center">
			<div className="flex flex-col w-max gap-4 h-full justify-center p-4">
				...
				<div className="my-10">
					...
					Nam ullamcorper vehicula diam et rhoncus. Sed sodales ac lacus et venenatis. Donec vel est turpis. Etiam congue venenatis massa, eu posuere nibh cursus vel. Nullam at euismod diam. Quisque sit amet neque vitae nunc pulvinar vulputate. Etiam tempor feugiat mauris in tincidunt.<br />
